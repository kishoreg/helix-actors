...
public class TestNettyHelixIPCService extends ZkUnitTestBase {
    ...
    public void testMessagePassing() throws Exception {
        ...
        firstIPC.registerCallback(messageType, new HelixIPCCallback() {
            @Override
            public void onMessage(String srcInstance, HelixMessageScope scope, UUID messageId, Object message) {
        ...
        firstIPC.registerMessageCodec(messageType, CODEC);
        firstIPC.start();
        ...
        secondIPC.registerMessageCodec(messageType, CODEC);
        secondIPC.start();
